...
// El frontend pide esto para mostrar el precio correcto (preventa o normal)
// ANTES de que la persona intente pagar, sin tener que hardcodear el monto
// en el HTML/JS del sitio.
